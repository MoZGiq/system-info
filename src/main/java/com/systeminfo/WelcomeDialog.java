...
public class WelcomeDialog {
    ...
    private String getGuaranteeHtml() {
        return """
                ...
                <h3 style='color: #1565c0;'>🔒 1. Данные не отправляются автоматически</h3>
                <ul>
                  <li>Программа <b>не отправляет данные автоматически</b></li>
                  <li>Все собранные данные остаются <b>на вашем компьютере</b></li>
                  <li>Отчёт сохраняется на ваш Рабочий стол</li>
                  <li><b>Опционально:</b> Вы можете <u>самостоятельно</u> отправить копию отчёта\s
                      на свой email, если введёте его в специальном поле.\s
                      Это требует <b>отдельного согласия</b>.</li>
                </ul>
